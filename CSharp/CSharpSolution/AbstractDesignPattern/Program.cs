...
namespace AbstractDesignPattern
{
    ...
    {
        public void GetDetails() => Console.WriteLine("Fetching RegularBike Details..");
    ...
    public class SportsBike : IBike 
    {
        ...
        {
            Console.WriteLine("GFetching SportsBike Details..");
        }
...
/*
 Note:-The Abstract Factory Design Pattern is another creational pattern, but it's used
